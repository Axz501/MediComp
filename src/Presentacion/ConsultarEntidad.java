 ...
 * @author Admin
 */
public class ConsultarEntidad extends JFrameConFondo {

    /**
     * Creates new form ConsultarEntidad
     */
    List<DtEntidad> enti;
    ...
    private void initComponents() {
        ...
        if (EntiTable.getColumnModel().getColumnCount() > 0) {
            ...
            EntiTable.getColumnModel().getColumn(4).setPreferredWidth(50);
            EntiTable.getColumnModel().getColumn(5).setPreferredWidth(130);
            EntiTable.getColumnModel().getColumn(6).setPreferredWidth(130);
        }
        ...
        jButton1.setText("Borrar De Mis Entidades");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (EntiTable.getSelectedRow() > -1) {
            ...
            if (Pac.BorrarEntidaddeMedico(id)){
                String nom = enti.get(EntiTable.getSelectedRow()).getNombre();
                JOptionPane.showMessageDialog(this, "La entidad "+nom+" ha sido removida","Entidad Removida", JOptionPane.INFORMATION_MESSAGE);
                listarEntidades("");
            }
            else{
                JOptionPane.showMessageDialog(this, "La entidad no ha podido ser eliminada","Operación Fallida", JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarEntidad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
